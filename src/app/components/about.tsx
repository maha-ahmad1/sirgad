        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6 pt-4">
              <div className="p-6 text-center border-cyan-500/20 bg-card/50 backdrop-blur">
                ...
                <div className="text-sm text-muted-foreground mt-2">Satisfied Clients</div>
              </div>
              <Card className="p-6 text-center border-cyan-500/20 bg-card/50 backdrop-blur">
                <div className="text-5xl font-bold relative">
                  <span
                    className="bg-gradient-to-r from-cyan-500 via-teal-400 to-yellow-400 bg-clip-text text-transparent"
                    style={{
                ...
                <div className="text-sm text-muted-foreground mt-2">Years Innovating</div>
              </Card>
            </div>
          </div>
